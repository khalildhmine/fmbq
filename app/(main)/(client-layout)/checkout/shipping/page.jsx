...
const ShippingPage = () => {
  ...
  //? Store
  const { cartItems, totalItems, totalDiscount, totalPrice, appliedCoupon } = useAppSelector(
    state => state.cart
  )

  const finalPrice = appliedCoupon
    ? totalPrice - totalDiscount - appliedCoupon.discountAmount
    ...
    if (
      ...
      postData({
        body: {
          ...
          cart: cartItems,
          totalItems,
          totalPrice: finalPrice, // Use the final price after coupon
          totalDiscount,
          paymentMethod,
      ...
      <main className="py-2 mx-auto space-y-3 xl:mt-28 container">
        ...
        <div className="lg:flex lg:gap-x-3">
          ...
          <section className="lg:border lg:border-gray-200 lg:rounded-md lg:h-fit">
            <CartInfo showCouponDetails={true} appliedCoupon={appliedCoupon} />
