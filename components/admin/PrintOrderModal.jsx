...
const PrintOrderModal = ({ isOpen, onClose, order }) => {
  ...
  const [pageSize, setPageSize] = useState('A4') // New: page size
  const [orientation, setOrientation] = useState('portrait') // New: orientation
  const [margin, setMargin] = useState('normal') // New: margin size
      ...
      <style jsx global>{`
        @media print {
          ...
          .print-container {
            ...
            min-height: ${pageSize === 'A4' ? '297mm' : '279mm'};
            margin: 0 auto;
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <Dialog.Panel className="relative bg-white rounded-lg max-w-4xl w-full mx-auto">
              ...
              {/* Print Settings Controls - VISIBLE */}
              <div className="flex flex-wrap gap-4 p-4 border-b justify-center items-center bg-gray-50">
                <div>
                ...
                <div>
                  <label className="mr-2 font-semibold">Orientation:</label>
                  <select
                    value={orientation}
                ...
                <div>
                  <label className="mr-2 font-semibold">Margins:</label>
                  <select
                    value={margin}
              ...
              <div className="p-6 max-h-[calc(100vh-300px)] overflow-y-auto">
                <div ref={componentRef} className="print-container"> {/* Add this class */}
                  {/* Invoice Template */}
                  {printType === 'invoice' && (
